                        ...
                        <div class="row gx-0">
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    ...
                                    <div class="services__style__two__content">
                                        ...
                                        <a href="services" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    ...
                                    <div class="services__style__two__content">
                                        <h3 class="title"><a href="services">Animation</a></h3>
                                        <p>Strategy is a forward-looking plan for your brand’s behavior.Strategy is a forward-looking plan.</p>
                                        <a href="services" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    ...
                                    <div class="services__style__two__content">
                                        <h3 class="title"><a href="services">Marketing</a></h3>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority.</p>
                                        <a href="services" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="services__style__two__item">
                                    ...
                                    <div class="services__style__two__content">
                                        <h3 class="title"><a href="services">Graphic Design</a></h3>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority.</p>
                                        <a href="services" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
